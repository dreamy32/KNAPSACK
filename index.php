                ...
                <div id="window-container" style="margin-top: unset;">
                    ...
                    <?php 
                            if(isset($_COOKIE['itemEval'])){
                                $moyenneEval = round(MoyenneEvaluations($_COOKIE['itemEval']),1);
                                $nbEvaluation = NombreEvaluations($_COOKIE['itemEval']);
                                $nb5etoile = floor(PourcentageHistogramme($_COOKIE['itemEval'],5));
                                $nb4etoile = floor(PourcentageHistogramme($_COOKIE['itemEval'],4));
                                $nb3etoile = floor(PourcentageHistogramme($_COOKIE['itemEval'],3));
                                $nb2etoile = floor(PourcentageHistogramme($_COOKIE['itemEval'],2));
                                $nb1etoile = floor(PourcentageHistogramme($_COOKIE['itemEval'],1));
                            }
                        ?>
                        <div>
                            ...
                            <br>
                            <br>
                            <span><?= $nbEvaluation ?> évaluations parmi le monde minecraftien</span>
                            <br>
                            <br>
