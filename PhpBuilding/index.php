                ...
                <div class="menu" onclick="afficherMenu()">
                    ...
                    <div class="contenuMenu" id="MenuPopUp">
                        ...
                        /*
                                ...
                                */
                        /* A changer lors de la creation des session */
                        /* Affiche le boutton profile, solde, et se deconnecter */
                            if (true) {
                                ...
                                echo '<a href="demande_Argent.php" style="text-decoration: none;"><div class="advancedSearch" style="margin:5%"> Solde:<?= $profile[1] ?><img style="width: 20px;" src="images/icons/ask_money.png" alt="caps"></a></div>';
                                echo '<a href="login.php" style="text-decoration: none;"><div class="advancedSearch" style="margin:5%"><p>Se Deconnecter</p></div></a>';
                            } else {
